...
async function handlecup(BId,RateV,UserV){
const url = 'http://localhost:3001/BookARate';
const data = { BId : BId,
   RId : RateV,
    UsId: UserV };
...
if (User) {
  ...
  return (
<div className="modal fade" id="AddComment" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="AddCommentLabel" aria-hidden="true">
  <div className="modal-dialog modal-lg">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-5" id="AddCommentLabel">Add Comment</h1>
      ...
      <form className="row g-3 needs-validation" noValidate>
        ...
        <button Rate="submit" className="btn btn-primary"
         onClick={()=> {handlecup(BId,RateV,UserV)}}
         >Submit</button>
      </div>
